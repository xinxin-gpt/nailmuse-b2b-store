...
export const metadata: Metadata = {
  title: "FAQ | Dedxc B2B Wholesale & Private Label Nail Manufacturer",
  description:
    "Frequently asked questions about Dedxc wholesale orders, MOQs, OEM/ODM, materials, shipping, lead times, certifications, and private label services.",
  keywords: [
    "Dedxc FAQ",
  ...
  openGraph: {
    title: "Dedxc B2B FAQ — Wholesale, OEM, MOQ, Shipping",
    description:
      "Everything beauty entrepreneurs and B2B buyers need to know before sourcing press-on nails, gel strips and nail tools from Dedxc.",
    type: "website",
...
const sections: Section[] = [
  {
    ...
    items: [
      ...
      {
        q: "Does Dedxc offer private label (OEM) and custom packaging services?",
        a: "Yes. Dedxc provides comprehensive Private Label (OEM/ODM) services. We can customize nail shapes, colors, finishes, and produce bespoke retail packaging with your brand logo. Our design team can assist in creating tech packs and mockups to ensure your brand stands out in the market."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      {
        q: "How long does it take for Dedxc to ship wholesale orders to the USA or Europe?",
      ...
      {
        q: "Does Dedxc ship internationally?",
  ...
  },
  {
    ...
    items: [
      {
        q: "How long do Dedxc press-on nails and gel strips last?",
      ...
      {
        q: "Are Dedxc products safe for professional salon use?",
